...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=SMETANK\\SQLEXPRESS;Database=PD_321;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.DayoffId).HasName("PK__DaysOFF__6603CDDA1D5C0E94");

            entity.ToTable("DaysOFF");

            entity.Property(e => e.DayoffId).HasColumnName("dayoff_id");
            ...
            entity.HasMany(d => d.Disciplines).WithMany(p => p.Directions)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<short>("Direction").HasColumnName("direction");
        ...
        modelBuilder.Entity<Group>(entity =>
        {
            ...
            entity.Property(e => e.LearningDays).HasColumnName("learning_days");
        ...
        {
            entity.HasKey(e => e.HolidayId).HasName("PK__tmp_ms_x__253884EA3BD86FC7");
        ...
        modelBuilder.Entity<Schedule>(entity =>
        {
            ...
            entity.ToTable("Schedule", tb => tb.HasTrigger("Trg_AfterScheduleUpdate_InsertCompleteDisciplines"));
